...
def get_deals():
    ...
    deals.append({'company': 'jcrew', 'image': 'static/jcrew.jpg', 'promo' : promoText, 'details': details})
    promoText, details = findSales("nyc", "http://www.nyandcompany.com/nyco/")
    deals.append({'company': 'nyc', 'image': 'static/nyco.jpg', 'promo' : promoText, 'details': details})
